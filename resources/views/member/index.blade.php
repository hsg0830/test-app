  ...
  <div id="app" class="container p-3">
    ...
    <div v-if="isCreate || isEdit">
      ...
      <div class="input-group mb-3">
        ...
        <input id="name" type="text" class="form-control" placeholder="例：山田太郎" v-model="currentMember.name"
      ...
      <div class="input-group mb-3">
        ...
        <input id="email" type="email" class="form-control" placeholder="例：user@example.com" v-model="currentMember.email"
      ...
      <div class="input-group mb-3">
        ...
        <select id="sex" class="form-select" aria-label="MemberSexuality" v-model="currentMember.sex">
          ...
          <option v-for="(value,key) in sexes" v-text="value" :value="key"></option>
        </select>
      </div>
      ...
      <div class="input-group mb-3">
        ...
        <input id="password" type="password" class="form-control" placeholder="パスワードを入力" v-model="currentMember.password"
          aria-label="MemberPassword" />
      </div>
      <div class="input-group mb-3">
        <label for="password-confirmation">パスワード再入力：</label>
        <input id="password-confirmation" type="password" class="form-control" placeholder="確認のためパスワードをもう一度入力"
          v-model="pwConfirmation" aria-label="MemberPasswordConfirmation" />
      </div>
