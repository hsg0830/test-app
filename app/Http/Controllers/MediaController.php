    ...
    function store(Request $request)
    {
        $request->validate([
            ...
            'media' => ($request->type === 'image')
                ...
                : ['required', 'mimetypes:video/x-ms-asf,video/x-flv,video/mp4,application/x-mpegURL,video/MP2T,video/3gpp,video/quicktime,video/x-msvideo,video/x-ms-wmv,video/avi', 'max:5000']
        ]);
